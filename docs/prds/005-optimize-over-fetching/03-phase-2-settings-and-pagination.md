...
-   **Problem:** The settings pages for Clients, Projects, and Hour Blocks fetch the *entire* content of their respective tables, including all relations, in a single "snapshot." This data is then filtered, sorted, and paginated on the client. This pattern is not scalable and will fail as data grows.
