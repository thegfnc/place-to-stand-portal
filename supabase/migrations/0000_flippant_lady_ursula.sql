...
CREATE INDEX "idx_activity_logs_client" ON "activity_logs" USING btree ("target_client_id" timestamptz_ops,"created_at" timestamptz_ops) WHERE (deleted_at IS NULL);--> statement-breakpoint
CREATE INDEX "idx_activity_logs_created_at" ON "activity_logs" USING btree ("created_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_activity_logs_project" ON "activity_logs" USING btree ("target_project_id" timestamptz_ops,"created_at" timestamptz_ops) WHERE (deleted_at IS NULL);--> statement-breakpoint
...
CREATE POLICY "Users view accessible users" ON "users" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
...
CREATE POLICY "Users view activity logs" ON "activity_logs" AS PERMISSIVE FOR SELECT TO public;
*/
