  ...
  return (
    <>
          ...
          <Form {...form}>
            ...
            >
              ...
              {isEditing ? (
                  ...
                  render={({ field }) => {
                    ...
                    return (
                      <FormItem>
                        ...
                        <FormDescription>
                          Leave blank to keep the existing password. Setting a
                          new one will require the user to update it on their
                          next login.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                ...
                <div className='border-border/60 bg-muted/20 text-muted-foreground rounded-md border px-3 py-2 text-sm'>
                  A secure temporary password will be generated and emailed to
                  the teammate. They must set a new password when they first
                  sign in.
                </div>
              )}
              {feedback ? (
      ...
      <ConfirmDialog
        ...
        title='Delete user?'
        description='Deleting this user will remove their access. Proceed?'
        confirmLabel='Delete'
